/*!
 * CodeJar 4.2.0 — a micro code editor (~2KB).
 * MIT License — Copyright (c) 2020 Anton Medvedev — https://github.com/antonmedv/codejar
 *
 * Vendored for offline use. This is the upstream dist/codejar.js (GOOS-agnostic,
 * dependency-free) with the ES module `export` replaced by a `window.CodeJar`
 * global so it can load via a classic <script> tag without a bundler.
 */
(function (root) {
  'use strict';
